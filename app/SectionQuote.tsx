    ...
    return (
        <section ref={ref} className={`safe-x-padding ${styles.sectionDistance}`} aria-label='Quote Section'>
            <div className='relative'>
                ...
                This portfolio is the result of an intense dedication to craftsmanship, where every line of code and design element was meticulously crafted with passion and creativity. It represents not just a collection of work, but a testament to my commitment and love for development.
                </motion.p>
